...
# WIN INSTALLER
  ...
  for line in fileinput.input(projectpath + "/installer/" + config['BUNDLE_NAME'] + ".iss",inplace=1):
    ...
    if "OutputBaseFilename" in line:
      if demo:
        line="OutputBaseFilename=ChordRecogniser Demo Installer\n"
      else:
        line="OutputBaseFilename=ChordRecogniser Installer\n"
    ...
    if "WelcomeLabel1" in line:
     if demo:
       line="WelcomeLabel1=Welcome to the ChordRecogniser Demo installer\n"
     else:
       line="WelcomeLabel1=Welcome to the ChordRecogniser installer\n"
       
    if "SetupWindowTitle" in line:
     if demo:
       line="SetupWindowTitle=ChordRecogniser Demo installer\n"
     else:
       line="SetupWindowTitle=ChordRecogniser installer\n"
