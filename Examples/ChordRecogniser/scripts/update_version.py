...
def main():
  ...
  plistpath = scriptpath + "/resources/ChordRecogniser-VST2-Info.plist"
  ...
  plistpath = scriptpath + "/resources/ChordRecogniser-AU-Info.plist"
  ...
  plistpath = scriptpath + "/resources/ChordRecogniser-VST3-Info.plist"
  ...
  plistpath = scriptpath + "/resources/ChordRecogniser-macOS-Info.plist"
  ...
  plistpath = scriptpath + "/resources/ChordRecogniser-AAX-Info.plist"
  ...
  plistpath = scriptpath + "/installer/ChordRecogniser.pkgproj"
  ...
  for line in fileinput.input(scriptpath + "/installer/ChordRecogniser.iss",inplace=1):
