...
/** A control to display the chord symbol a given set of notes represents */
class IChordTextControl : public ITextControl
{
public:
    IChordTextControl(const IRECT& bounds,
                      const char* str = "",
    ...
    /** update chord text based on notes in this.notes */
